...
func newLogsRequestUnmarshallerFunc(pusher consumerhelper.ConsumeLogsFunc) requestUnmarshaller {
...
func NewLogsExporter(
	...
	be := newBaseExporter(cfg, logger, newLogsRequestUnmarshallerFunc(pusher), options...)
